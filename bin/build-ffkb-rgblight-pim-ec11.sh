...
cp keyboards/xoiviox/ffkb/config-rgblight-pim-ec11.h keyboards/xoiviox/ffkb/config.h
cp keyboards/xoiviox/ffkb/rules-rgblight-pim-ec11.mk keyboards/xoiviox/ffkb/rules.mk
...
cp .build/xoiviox_ffkb_sadekbaroudi* /mnt/g/My\ Drive/qmk-keyboards/ffkb-rgblight-pim-ec11/
